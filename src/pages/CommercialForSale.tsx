...
const CommercialForSale = () => (
  <UnitCategoryPage
    metaTitle="Commercial Units for Sale in Shorouk City"
    metaDescription="Looking for commercial units for sale in Shorouk? Discover premium commercial properties in Shorouk City's most active malls with ASWAQ."
    ...
    malls={[
      { name: "Solaria Mall", href: "/projects/solaria-mall", description: "A modern retail destination designed to serve surrounding residential compounds, offering excellent visibility and daily foot traffic for commercial properties; shops, cafés, and service providers.", sizes: "Spaces from 30 m² to 396 m²" },,
