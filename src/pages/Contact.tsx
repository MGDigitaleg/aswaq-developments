...
const requestTypes = ["Buy a Unit", "Invest", "Rent a Unit", "Book Consultation", "General Inquiry"];
...
const Contact = () => {
  ...
  const inputClass =
    "w-full px-4 py-3.5 border border-border rounded-xl bg-background text-foreground font-body text-sm placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-accent/40 focus:border-accent/40 transition-all duration-300";
  const selectClass =
    "w-full px-4 py-3.5 border border-border rounded-xl bg-background text-foreground font-body text-sm focus:outline-none focus:ring-2 focus:ring-accent/40 focus:border-accent/40 transition-all duration-300 appearance-none cursor-pointer";
      ...
      <section className="relative py-24 lg:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 text-center relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <p className="text-accent font-body font-semibold tracking-[0.2em] uppercase text-xs mb-3">Get In Touch</p>
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground mb-6">
              Contact Us
            </h1>
            <p className="text-primary-foreground/60 font-body max-w-2xl mx-auto text-base">
              Have questions about our projects or available units? Reach out and we'll help you find the perfect space.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
                ...
                {submitted ? (
                  <div className="text-center py-16">
                    ...
                    <button
                      ...
                      className="bg-accent text-accent-foreground px-6 py-2.5 text-sm font-semibold rounded-lg hover:bg-gold-light transition-colors font-body"
                    >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div>
                        <label className="block text-xs font-semibold text-foreground/70 font-body mb-1.5 uppercase tracking-wider">
                          Full Name *
                        </label>
                        <input
                          type="text"
                      ...
                      <div>
                        ...
                        <div className="flex">
                          <select
                            ...
                            className="inline-flex items-center px-3 border border-r-0 border-border rounded-l-xl bg-muted text-sm text-muted-foreground font-body focus:outline-none focus:ring-2 focus:ring-accent/40 appearance-none cursor-pointer min-w-[90px]"
                          >
                            {countryCodes.map((c) => (
                    ...
                    <button
                      type="submit"
                      disabled={submitting}
                      className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-accent text-accent-foreground px-10 py-3.5 font-semibold rounded-xl hover:bg-gold-light transition-all duration-300 font-body text-sm disabled:opacity-50 shadow-gold"
                    >
            ...
            >
              ...
              <div className="p-6 rounded-2xl bg-primary text-primary-foreground mt-2">
                <p className="font-display font-bold text-base mb-2">Trusted by 400+ Clients</p>
                <p className="text-primary-foreground/60 text-sm font-body leading-relaxed">
                  Over 20 years of real estate expertise. Your investment is in safe hands.
                </p>
              </div>
            </motion.div>
          </div>
...
const ChevronIcon = () => (
  <svg
    className="absolute right-3 bottom-3.5 pointer-events-none text-muted-foreground"
    width="16"
    height="16"
    viewBox="0 0 24 24"
    fill="none"
