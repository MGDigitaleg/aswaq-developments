...
const faqs = [
  ...
  { question: "أين يمكنني شراء وحدة في مدينة الشروق؟", answer: "توفر أسواق تشكيلة متنوعة من المساحات التجارية والإدارية والطبية للبيع في أربعة مولات كبرى: سولاريا مول، أرينا مول، ميركادو مول، وسيتي هب مول. تتراوح مساحات هذه الوحدات من 24 م² حتى 300 م²." },
