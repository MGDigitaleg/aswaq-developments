...
const projects = [
  ...
  },
  {
    name: "ميركادو مول",
    image: mercadoImg,
    description: "أكبر مول تجاري في مدينة الشروق، يمتد على ثلاث طوابق ويقدم مجموعة واسعة من الوحدات التجارية. تبدأ مساحاته من 29 متر مربع للإيجار.",
  },
  {
    name: "أرينا مول",
    image: arenaImg,
...
const faqs = [
  ...
  },
  {
    ...
    answer: "إذا كنت ترغب في شراء وحدة في مدينة الشروق، فإن شركة أسواق للتطوير العقاري توفر مجموعة من المساحات التجارية ومساحات التجزئة للبيع عبر وجهاتها الأربع الكبرى: سولاريا مول، أرينا مول، ميركادو مول، وسيتي هب مول. وتتراوح مساحات هذه الوحدات من 30 م² وتصل إلى 300 م²، مما يوفر خيارات مرنة للجميع.",
  },
  {
