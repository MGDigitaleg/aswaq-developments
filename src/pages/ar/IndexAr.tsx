...
const IndexAr = () => {
  ...
  return (
    <Layout>
            ...
            <Link to={`/ar/projects/${editorialProjects[0].slug}`} className="group block">
              <div className="relative overflow-hidden rounded-2xl aspect-[2/1] md:aspect-[2.6/1]" style={{ boxShadow: 'var(--shadow-xl)' }}>
                <img
                  ...
                  loading="lazy"
                />
                <div className="absolute inset-0 bg-gradient-to-l from-primary/90 via-primary/50 to-primary/10" />
                <div className="absolute bottom-0 right-0 p-7 md:p-10 lg:p-12 max-w-xl">
                  ...
                  <span className="inline-block text-[9px] font-arabic font-bold tracking-[0.2em] text-primary-foreground/45 mb-1.5">
                  ...
                  <p className="text-primary-foreground/50 text-[13px] font-arabic leading-relaxed mb-5 max-w-md">
                    {editorialProjects[0].description}
                  </p>
                  <span className="inline-flex items-center gap-2.5 text-[11px] font-bold font-arabic tracking-[0.12em] px-5 py-2.5 rounded-lg border border-primary-foreground/25 text-primary-foreground/80 group-hover:bg-primary-foreground/10 group-hover:border-primary-foreground/40 transition-all duration-300">
      ...
      <section className="py-12 md:py-16 bg-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <Link to={`/ar/projects/${editorialProjects[1].slug}`} className="group grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              {/* Image */}
              ...
              <div className="order-2 lg:order-1 py-2">
                ...
                <span className="inline-block text-[9px] font-arabic font-bold tracking-[0.2em] text-foreground/30 mb-2">
                ...
                <span className="inline-flex items-center gap-2.5 text-[11px] font-bold font-arabic tracking-[0.12em] px-5 py-2.5 rounded-lg border border-foreground/15 text-foreground/60 group-hover:border-foreground/30 group-hover:text-foreground transition-all duration-300">
      ...
      <section className="py-12 md:py-16 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <Link to={`/ar/projects/${editorialProjects[2].slug}`} className="group grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              {/* Image */}
      ...
      {/* ═══════════════ سيتي هب — CONTENT RIGHT / IMAGE LEFT ═══════════════ */}
      <section className="py-12 md:py-16 pb-20 md:pb-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <Link to={`/ar/projects/${editorialProjects[3].slug}`} className="group grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              {/* Image */}
              <div className="order-1 lg:order-2 relative overflow-hidden rounded-2xl aspect-[5/4]" style={{ boxShadow: 'var(--shadow-xl)' }}>
                <img
