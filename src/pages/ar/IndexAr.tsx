...
const IndexAr = () => {
  ...
  return (
    <Layout>
      ...
      {/* ═══════════════ PORTFOLIO HEADER ═══════════════ */}
      <section className="pt-20 md:pt-28 pb-8 bg-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            <Link to={`/ar/projects/${editorialProjects[0].slug}`} className="group block">
              <div className="relative overflow-hidden rounded-2xl aspect-[21/9] md:aspect-[2.4/1]" style={{ boxShadow: 'var(--shadow-xl)' }}>
                ...
                <div className="absolute bottom-0 right-0 p-8 md:p-12 max-w-xl">
                  ...
                  <span className="inline-block text-[9px] font-arabic font-bold tracking-[0.18em] text-primary-foreground/50 mb-2">
                  ...
                  <p className="text-primary-foreground/55 text-[13.5px] font-arabic leading-relaxed mb-5 max-w-md">
                    {editorialProjects[0].description}
                  </p>
                  <span className="inline-flex items-center gap-2 text-[12px] font-bold font-arabic text-primary-foreground/70 group-hover:text-primary-foreground transition-colors tracking-wide">
      ...
      <section className="py-10 md:py-16 bg-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <Link to={`/ar/projects/${editorialProjects[1].slug}`} className="group grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14 items-center">
              {/* Image */}
              ...
              <div className="order-2 lg:order-1">
                <div className="w-12 h-12 rounded-xl bg-white border border-border/40 flex items-center justify-center p-1 mb-5" style={{ boxShadow: 'var(--shadow-sm)' }}>
                  <img src={editorialProjects[1].logo} alt="" className="w-full h-full object-contain" />
                </div>
                <span className="inline-block text-[9px] font-arabic font-bold tracking-[0.18em] text-foreground/35 mb-3">
                ...
                <p className="text-muted-foreground text-[14px] font-arabic leading-[1.8] mb-2 max-w-md">
                  {editorialProjects[1].description}
                </p>
                <p className="text-[11px] font-arabic text-foreground/35 tracking-wide mb-6 flex items-center gap-1.5">
                  <MapPin size={11} /> {editorialProjects[1].location}
                </p>
                <span className="inline-flex items-center gap-2 text-[12px] font-bold font-arabic text-foreground/60 group-hover:text-foreground transition-colors tracking-wide">
      ...
      <section className="py-10 md:py-16 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <Link to={`/ar/projects/${editorialProjects[2].slug}`} className="group grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14 items-center">
              {/* Image */}
              ...
              <div>
                ...
                <span className="inline-block text-[9px] font-arabic font-bold tracking-[0.18em] text-foreground/35 mb-3 mt-5">
      ...
      <section className="py-10 md:py-16 pb-20 md:pb-28 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <Link to={`/ar/projects/${editorialProjects[3].slug}`} className="group grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14 items-center">
              {/* Image */}
              <div className="order-1 lg:order-2 relative overflow-hidden rounded-2xl aspect-[4/3]" style={{ boxShadow: 'var(--shadow-xl)' }}>
                <img
