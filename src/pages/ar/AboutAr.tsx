      ...
      <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="relative z-10 text-center px-4 max-w-3xl">
          ...
          <p className="text-primary-foreground/80 font-arabic max-w-2xl mx-auto">
            تأسست أسواق للتطوير العقاري في عام 2019 كمحطة استراتيجية ترتكز على أكثر من 20 عاماً من النجاح المثبت في قطاعات السكنية والتجارية والصناعية والمنتجعات. تأسست أسواق بالشراكة مع شركات عقارية نشطة منذ عام 2002، وتم إنشاؤها لتبسيط إدارة المشاريع الحالية والمستقبلية، وتعزيز الربحية، وتجاوز توقعات العملاء مع فتح أسواق جديدة بتنويع فرص الاستثمار والتوظيف. منذ تأسيسها، واصلت أسواق الازدهار من خلال تقديم مشاريع عقارية عالية الجودة في القطاعات السكنية والتجارية والإدارية والطبية، حيث تقدم وحدات متميزة للإيجار وعقارات استثنائية للبيع في مصر، وكل ذلك مدفوع بالتزام قوي بالتميز والقيمة طويلة الأجل.
          </p>
        </motion.div>
      </section>
