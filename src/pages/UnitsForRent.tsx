...
const unitCategories = [
  {
    title: "Commercial Units for Rent",
    icon: ShoppingBag,
  ...
  {
    title: "Administrative Units for Rent",
    icon: Briefcase,
...
const faqs = [
  ...
  { question: "How do I rent a unit or property in Shorouk City?", answer: "You first decide the type of property that matches your needs, discover the types we offer and locations, then contact us to request your unit." },
  { question: "Where can I rent a unit in Shorouk city?", answer: "ASWAQ Developments offers a range of commercial and retail spaces for rent across four major mall destinations: Solaria Mall, Arena Mall, Mercado Mall, and City Hub Mall." },
  ...
  { question: "Are there flexible payment plans for renting units?", answer: "Yes. ASWAQ Developments offers flexible rental plans. Contact our sales team for details." },
];
...
const UnitsForRent = () => {
  ...
  return (
    <Layout>
      <section className="bg-primary py-24">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <p className="text-accent font-body font-medium tracking-widest uppercase text-sm mb-3">Units for Rent</p>
            ...
            <p className="text-primary-foreground/70 font-body max-w-3xl mx-auto">
              Discover a wide selection of units for rent across ASWAQ Developments' strategically located mixed-use projects. Whether you're searching for commercial, administrative, or medical units, ASWAQ offers ready-to-operate properties designed for growth, flexibility, and visibility.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <CTASection title="Request Unit Details" subtitle="Discover commercial, administrative, and medical properties for rent across ASWAQ's mixed-use developments." buttonText="Request Unit Details" buttonLink="/contact" />
    </Layout>
  );
};
