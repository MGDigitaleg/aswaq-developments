...
const faqs = [
  ...
  { question: "Where can I buy a unit in Shorouk city?", answer: "ASWAQ Developments offers a range of commercial and retail spaces for sale across four major mall destinations: Solaria Mall, Arena Mall, Mercado Mall, and City Hub Mall. Units range from 30 m² up to 300 m²." },
    ...
    <Layout>
      <section className="bg-primary py-24">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <p className="text-accent font-body font-medium tracking-widest uppercase text-sm mb-3">Units for Sale</p>
            <h1 className="font-display text-4xl md:text-5xl font-bold text-primary-foreground mb-6">
              Own a Property Designed for Growth
            </h1>
            <p className="text-primary-foreground/70 font-body max-w-3xl mx-auto">
              Discover a curated selection of units for sale across ASWAQ Developments' most strategic real estate projects. Whether you're seeking commercial, administrative, or medical units, our mixed-use properties are designed for operational success and long-term value.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 lg:px-8">
          <h2 className="font-display text-3xl font-bold text-foreground text-center mb-4">Units for Sale Types</h2>
      ...
      <section className="py-20 bg-cream">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          <h2 className="font-display text-3xl font-bold text-foreground mb-4">Our Malls with Units for Sale</h2>
          <p className="text-muted-foreground font-body max-w-2xl mx-auto mb-12">
            Each mall is developed to serve high-density residential areas, ensuring continuous demand for commercial, administrative, and medical properties.
          </p>
      ...
      <CTASection title="Request Unit Details" subtitle="Discover commercial, administrative, and medical properties for sale across ASWAQ's mixed-use real estate developments." buttonText="Request Unit Details" buttonLink="/contact" />
    </Layout>
  );
};

export default UnitsForSale;
