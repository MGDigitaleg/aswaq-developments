...
const UnitsForInvestment = () => {
  useSEO("Units for investment in Egypt | Commercial & Mixed-Use Property", "Explore investment units across ASWAQ developments. Discover commercial, administrative, and medical properties designed for rental income and long-term value growth in Egypt.");
    ...
    <Layout>
      <section className="bg-primary py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <p className="text-primary-foreground/60 font-body font-medium tracking-widest uppercase text-sm mb-3">Units for Investment</p>
      ...
      <section className="py-12 md:py-16 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-display text-3xl font-bold tracking-tight text-foreground text-center mb-4">Units for Investment Types</h2>
      ...
      <section className="py-12 md:py-16 bg-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-display text-3xl font-bold tracking-tight text-foreground mb-4">Our Malls with Units for Investment</h2>
