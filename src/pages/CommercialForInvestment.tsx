...
const CommercialForInvestment = () => (
  <UnitCategoryPage
    ...
    malls={[
      { name: "Solaria Mall", href: "/projects/solaria-mall", description: "Establish your brand in a sophisticated, next-generation mall designed for luxury and accessibility. Located near the Suez Road and major institutions.", sizes: "Spaces from 30 m² to 396 m²" },,
      { name: "Arena Mall", href: "/projects/arena-mall", description: "Capitalize on a young, active demographic directly across from the French University. With the city's first dedicated food court and a constant stream of students and professionals.", sizes: "Spaces from 16 m² to 343 m²" },
