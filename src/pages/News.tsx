        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-40">
          <motion.div initial={{ opacity: 0, y: 25 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-xs font-body font-semibold tracking-[0.25em] uppercase text-primary-foreground/45">Insights & Updates</p>
            </div>
            <h1 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-primary-foreground leading-tight max-w-xl">
              News & Events
            </h1>
            <p className="font-body text-primary-foreground/55 max-w-lg mt-4 text-[15px] leading-relaxed">
              Stay updated with the latest from ASWAQ Developments — project launches, milestones, and investment insights.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <>
                  ...
                  >
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                      ...
                      <div className="p-8 md:p-10 lg:p-12 flex flex-col justify-center">
                        <span className="inline-flex items-center gap-1.5 text-[10px] font-body font-bold tracking-[0.2em] uppercase text-accent/60 mb-4">
                          Featured Article
                        </span>
                        ...
                        <p className="text-muted-foreground font-body text-[14.5px] leading-[1.7] mt-4 line-clamp-3">
                          {leadArticle.excerpt}
                        </p>
                        <div className="mt-6">
                          <span className="inline-flex items-center gap-2 text-[12px] font-bold font-body tracking-[0.1em] uppercase text-foreground/70 group-hover:text-accent group-hover:gap-3 transition-all duration-300">
              ...
              {restArticles.length > 0 && (
                <div className="flex items-center gap-4 mb-10">
                  ...
                  <span className="text-[10px] font-body font-bold tracking-[0.25em] uppercase text-foreground/30">
                    All Articles
                  </span>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="p-5 md:p-6">
                        ...
                        <p className="text-[13px] text-muted-foreground font-body mt-2.5 line-clamp-2 leading-relaxed">
                          {article.excerpt}
                        </p>
                        <span className="inline-flex items-center gap-1.5 text-[12px] text-foreground/60 mt-4 font-body font-semibold group-hover:gap-2.5 group-hover:text-accent transition-all duration-300">
