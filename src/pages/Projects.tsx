    ...
    <Layout>
      ...
      <section className="relative min-h-[420px] md:min-h-[480px] flex items-end pb-16 md:pb-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-40">
          ...
          >
            <p className="text-xs font-body font-semibold tracking-[0.25em] uppercase mb-4" <p className="text-xs font-body font-semibold tracking-[0.25em] uppercase mb-4 text-primary-foreground/45">Our Portfolio</p>>Our Portfolio</p>
