...
const Projects = () => {
  ...
  return (
    <Layout>
      ...
      {/* Hero Banner */}
      <section className="relative h-[360px] md:h-[440px] min-h-[450px] flex items-center justify-center pt-[120px] overflow-hidden">
        <img
          src={heroImg}
