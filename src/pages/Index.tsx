        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-[5px]">
          <div className="text-center mb-16">
            ...
            >
              ...
              <h2 className="font-display text-3xl md:text-4xl lg:text-[2.75rem] font-bold text-[#0A1128] mb-5 leading-tight">
                ASWAQ Developments, The Trusted Real Estate Developer in Egypt
              </h2>
              <p className="text-[#0A1128]/70 max-w-3xl mx-auto font-body text-base md:text-lg leading-relaxed">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-16">
            {stats.map((stat, i) => (
              <motion.div
                ...
                className="text-center p-6 md:p-8 rounded-xl bg-white/60 backdrop-blur-sm border border-stone-200/50 hover:-translate-y-1 transition-all duration-300 ease-in-out"
                style={{ boxShadow: '0 4px 20px -4px rgba(10,17,40,0.1)' }}
              >
                <div className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-[#0A1128] mb-2">
                  <AnimatedCounter value={stat.value} />
                </div>
                <div className="text-sm text-[#0A1128]/70 font-body">{stat.label}</div>
              </motion.div>
            ))}
          </div>
        </div>
