    ...
    <section className="relative bg-primary py-14 md:py-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          ...
          <Link
            to={resolvedLink}
            className="group inline-flex items-center gap-2 bg-[#D4AF37] text-[#0A1128] font-bold tracking-wide border border-transparent rounded-lg px-10 py-4 transition-all duration-300 ease-in-out hover:bg-[#0A1128] hover:text-[#D4AF37] hover:border-[#D4AF37] hover:-translate-y-1 hover:shadow-[0_4px_20px_rgba(212,175,55,0.3)] font-body text-sm md:text-base"
            data-cursor-hover
          >
            {buttonText}
