...
const floorsData: FloorData[] = [
  {
    ...
    units: [
      ...
      // ── Center grid: 43-48 ──
      u("gf-43","43","52 m²","Retail","Available", 50,43, 5.5,4.5),
      u("gf-44","44","48 m²","Retail","Available", 39,44, 6,5),
      u("gf-45","45","50 m²","Retail","Available", 46,44, 6,5),
      u("gf-46","46","49 m²","Retail","Available", 53,47, 5.5,4.5),
      u("gf-47","47","51 m²","Retail","Available", 47,47, 6,4.5),
      u("gf-48","48","46 m²","Retail","Available", 42,47, 5,4.5),
      // ── Left-center: 49-56 ──
      u("gf-49","49","49 m²","Retail","Available", 36,51, 6,5),
      u("gf-50","50","49 m²","Retail","Available", 30,46, 6,5),
      u("gf-51","51","51 m²","Retail","Available", 26,46, 6,5),
      u("gf-52","52","49 m²","Retail","Available", 21,44, 6.5,5),
      u("gf-53","53","45 m²","Retail","Sold", 26,50, 6,5),
      u("gf-54","54","48 m²","Retail","Available", 27,53, 6,5),
      u("gf-55","55","102 m²","Retail","Available", 33,52, 10,7),
      u("gf-56","56","51 m²","Retail","Available", 27,56, 6,5),
      // ── Center-lower: 57 ──
  ...
  },
  {
    ...
    units: [
      ...
      u("1f-101","101","95 m²","Retail","Available", 82,10, 6,11),
      u("1f-102","102","75 m²","Retail","Available", 68,10, 12,11),
      // Right strip: 103-110
      u("1f-103","103","57 m²","Retail","Available", 80,31, 6,6),
      u("1f-104","104","53 m²","Retail","Available", 80,37.5, 6,5.5),
      u("1f-105","105","53 m²","Retail","Available", 80,43.5, 6,5.5),
      u("1f-106","106","53 m²","Retail","Reserved", 80,49.5, 6,5.5),
      u("1f-107","107","53 m²","Retail","Available", 80,55.5, 6,5.5),
      u("1f-108","108","53 m²","Retail","Available", 80,61.5, 6,5.5),
      u("1f-109","109","53 m²","Retail","Available", 80,67.5, 6,5.5),
      u("1f-110","110","77 m²","Retail","Available", 80,74, 6,7),
      // Center-left column: 113-118
      u("1f-113","113","75 m²","Retail","Available", 53,11, 10,8),
      u("1f-114","114","82 m²","Retail","Available", 51,20, 11,9),
      u("1f-115","115","51 m²","Retail","Available", 51,30, 7,6),
      u("1f-116","116","52 m²","Retail","Available", 51,37, 7,6),
      u("1f-117","117","43 m²","Retail","Available", 55,44, 6,5),
      u("1f-118","118","40 m²","Retail","Sold", 55,50, 6,5),
      // Center block: 119-121
      u("1f-119","119","99 m²","Retail","Available", 38,42, 13,10),
      u("1f-120","120","50 m²","Retail","Available", 37,55, 9,6),
      u("1f-121","121","55 m²","Retail","Available", 38,47, 8,5),
      // Mid-height row: 122-125
      u("1f-122","122","57 m²","Retail","Available", 54,56, 7,5),
      u("1f-123","123","48 m²","Retail","Available", 47,56, 6,5),
      u("1f-124","124","52 m²","Retail","Available", 41,56, 6,5),
      u("1f-125","125","117 m²","Retail","Available", 32,52, 9,7),
      // Left column: 126-130
      u("1f-126","126","49 m²","Retail","Available", 30,56, 7,6),
      u("1f-127","127","54 m²","Retail","Available", 31,63, 7,6),
      u("1f-128","128","49 m²","Retail","Available", 30,72, 7,6),
      u("1f-129","129","52 m²","Retail","Available", 30,79, 7,6),
      u("1f-130","130","88 m²","Retail","Available", 31,86, 9,7),
      // Large units
      u("1f-131","131","250 m²","Retail","Available", 10,58, 18,18),
      u("1f-132","132","276 m²","Retail","Available", 43,82, 18,13),
      // Bottom-right: 111-112
      u("1f-111","111","91 m²","Retail","Available", 80,82, 8,7),
      u("1f-112","112","187 m²","Retail","Available", 72,90, 13,8),
    ],
  },
  {
    ...
    units: [
      // Top block: 202, 201
      u("2f-202","202","122 m²","Administrative","Available", 64,7, 14,12),
      u("2f-201","201","46 m²","Administrative","Available", 79,12, 7,8),
      // Center-right strip: 203-208
      u("2f-203","203","36 m²","Medical","Available", 67,22, 7,6),
      u("2f-204","204","37 m²","Medical","Available", 67,29, 7,6),
      u("2f-205","205","37 m²","Medical","Available", 67,36, 7,6),
      u("2f-206","206","37 m²","Medical","Reserved", 67,43, 7,5.5),
      u("2f-207","207","37 m²","Medical","Available", 67,49, 7,5.5),
      u("2f-208","208","39 m²","Medical","Available", 67,55, 7,6),
      u("2f-209","209","66 m²","Administrative","Available", 76,38, 9,11),
      // Far-right strip: 210-215
      u("2f-210","210","49 m²","Administrative","Available", 83,50, 7,5),
      u("2f-211","211","49 m²","Administrative","Available", 83,55.5, 7,5),
      u("2f-212","212","49 m²","Medical","Available", 83,61, 7,5),
      u("2f-213","213","49 m²","Administrative","Available", 83,66.5, 7,5),
      u("2f-214","214","49 m²","Administrative","Sold", 83,72, 7,5),
      u("2f-215","215","49 m²","Medical","Available", 83,77.5, 7,5),
      // Right lower: 216-218
      u("2f-216","216","69 m²","Administrative","Available", 81,83, 9,6),
      u("2f-217","217","55 m²","Administrative","Available", 81,89, 8,6),
      u("2f-218","218","221 m²","Medical","Available", 78,95, 12,5),
      // Left upper column: 219-222
      u("2f-219","219","80 m²","Administrative","Available", 50,16, 10,9),
      u("2f-220","220","46 m²","Administrative","Available", 53,26, 7,7),
      u("2f-221","221","38 m²","Medical","Available", 53,34, 7,6),
      u("2f-222","222","78 m²","Medical","Available", 53,41, 8,10),
      // Center block: 223-224
      u("2f-223","223","39 m²","Administrative","Available", 40,40, 9,9),
      u("2f-224","224","70 m²","Administrative","Available", 40,50, 9,8),
      // Center-lower block: 225-228
      u("2f-225","225","86 m²","Administrative","Available", 48,58, 10,8),
      u("2f-226","226","121 m²","Medical","Available", 48,67, 12,10),
      u("2f-227","227","63 m²","Administrative","Reserved", 41,67, 7,8),
      u("2f-228","228","63 m²","Administrative","Available", 34,64, 8,9),
      // Left lower: 229-233
      u("2f-229","229","38 m²","Medical","Available", 28,61, 6,7),
      u("2f-230","230","38 m²","Administrative","Available", 35,73, 6,6),
      u("2f-231","231","40 m²","Administrative","Available", 38,79, 6.5,6),
      u("2f-232","232","43 m²","Administrative","Available", 38,85, 7,6),
      u("2f-233","233","104 m²","Administrative","Available", 36,91, 9,8),
      // Far left: 234-236
      u("2f-234","234","108 m²","Administrative","Available", 12,70, 13,10),
      u("2f-235","235","74 m²","Medical","Available", 14,58, 12,10),
      u("2f-236","236","54 m²","Administrative","Available", 20,58, 7,6),
    ],
  },
  {
    ...
    units: [
      // Top-right: 302, 301
      u("3f-302","302","122 m²","Administrative","Available", 64,7, 14,12),
      u("3f-301","301","46 m²","Administrative","Available", 79,12, 7,8),
      // Right strip: 303-308
      u("3f-303","303","36 m²","Medical","Available", 67,22, 7,6),
      u("3f-304","304","37 m²","Medical","Available", 67,29, 7,6),
      u("3f-305","305","37 m²","Medical","Available", 67,36, 7,6),
      u("3f-306","306","37 m²","Medical","Reserved", 67,43, 7,5.5),
      u("3f-307","307","37 m²","Medical","Available", 67,49, 7,5.5),
      u("3f-308","308","39 m²","Medical","Available", 67,55, 7,6),
      u("3f-309","309","66 m²","Administrative","Available", 76,38, 9,11),
      // Right column: 310-316
      u("3f-310","310","49 m²","Administrative","Available", 83,50, 7,5),
      u("3f-311","311","49 m²","Administrative","Available", 83,55.5, 7,5),
      u("3f-312","312","49 m²","Medical","Available", 83,61, 7,5),
      u("3f-313","313","49 m²","Administrative","Sold", 83,66.5, 7,5),
      u("3f-314","314","49 m²","Administrative","Available", 83,72, 7,5),
      u("3f-315","315","49 m²","Medical","Available", 83,77.5, 7,5),
      u("3f-316","316","89 m²","Administrative","Available", 81,83, 9,6),
      // Upper center: 319-322
      u("3f-319","319","80 m²","Administrative","Available", 50,16, 10,9),
      u("3f-320","320","46 m²","Administrative","Available", 53,26, 7,7),
      u("3f-321","321","38 m²","Medical","Available", 53,34, 7,6),
      u("3f-322","322","78 m²","Medical","Available", 53,41, 8,10),
      // Center: 323-329
      u("3f-323","323","99 m²","Administrative","Reserved", 40,40, 9,9),
      u("3f-324","324","70 m²","Administrative","Available", 40,50, 9,8),
      u("3f-325","325","86 m²","Administrative","Available", 48,58, 10,8),
      u("3f-326","326","121 m²","Administrative","Available", 48,67, 12,10),
      u("3f-327","327","63 m²","Administrative","Available", 41,67, 7,8),
      u("3f-328","328","83 m²","Administrative","Available", 34,64, 8,9),
      u("3f-329","329","38 m²","Medical","Available", 28,61, 6,7),
      // Left-bottom: 330-336
      u("3f-330","330","38 m²","Administrative","Available", 35,73, 6,6),
      u("3f-331","331","40 m²","Administrative","Available", 38,79, 6.5,6),
      u("3f-332","332","43 m²","Administrative","Available", 38,85, 7,6),
      u("3f-333","333","104 m²","Administrative","Available", 36,91, 9,8),
      u("3f-334","334","108 m²","Administrative","Available", 12,70, 13,10),
      u("3f-335","335","34 m²","Medical","Sold", 14,58, 6,6),
      u("3f-336","336","54 m²","Administrative","Available", 20,58, 7,6),
      // Bottom-right: 317-318
      u("3f-317","317","55 m²","Medical","Available", 81,89, 8,6),
      u("3f-318","318","221 m²","Medical","Available", 78,95, 12,5),
    ],
  },
  {
