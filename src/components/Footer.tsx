      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-2 lg:pr-10">
            ...
            <p className={`text-primary-foreground/50 text-sm leading-[1.85] ${fontClass} mb-8 max-w-sm`}>
              {isArabic
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-lg bg-primary-foreground/[0.05] border border-primary-foreground/[0.08] flex items-center justify-center text-primary-foreground/45 hover:bg-primary-foreground/[0.10] hover:text-primary-foreground/80 hover:border-primary-foreground/15 transition-all duration-300"
          ...
          <div>
            ...
            <ul className={`space-y-3 ${fontClass}`}>
              {projectLinks.map((p) => (
                <li key={p.name}><Link to={p.href} className="text-[13px] text-primary-foreground/45 hover:text-primary-foreground/80 transition-colors duration-300">{p.name}</Link></li>
              ))}
            </ul>
            ...
            <ul className={`space-y-3 ${fontClass}`}>
              {unitLinks.map((u) => (
                <li key={u.href}><Link to={u.href} className="text-[13px] text-primary-foreground/45 hover:text-primary-foreground/80 transition-colors duration-300">{u.name}</Link></li>
              ))}
            </ul>
          </div>
